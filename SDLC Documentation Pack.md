...
**Project Goal:** Real-time AQI (Air Quality Indicator)/weather insights, predictive analytics, historical trends, interactive maps, alerts & recommendations.
...
- Security: HTTPS, bcrypt, JWT, RBAC (Role Based Access Control)
